  ...
  return (
    <div className={cn(
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 left-0 w-48 h-48 rounded-full bg-hold/10 blur-3xl translate-y-1/2 -translate-x-1/4" />
      </div>
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="text-lg font-bold text-foreground">💎 VIP Tickets</span>
          ...
          <ul className="space-y-3">
            {FEATURES.map(({ icon: Icon, text }) => (
              <li key={text} className="flex items-center gap-3">
                <div className="flex items-center justify-center w-7 h-7 rounded-lg bg-hold/15 shrink-0">
                  <Icon className="h-3.5 w-3.5 text-hold" />
                </div>
