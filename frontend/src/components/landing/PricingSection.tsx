...
export function PricingSection() {
  return (
    <section id="pricing" className="py-20 bg-card relative overflow-hidden border-t border-border scroll-mt-16">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full border border-[#d4a017]/30 bg-card text-[#d4a017] text-xs font-bold tracking-widest uppercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto items-stretch">
          ...
          {/* Card 1: Free Trial */}
          <div className="bg-background border border-border rounded-lg p-8 flex flex-col justify-between hover-glow transition-colors duration-150">
            <div className="space-y-6">
              <div className="space-y-2">
                <h3 className="text-xl font-bold text-foreground uppercase tracking-wider">Free Trial</h3>
            ...
            <div className="pt-8 mt-8 border-t border-border">
              <Link
                href="/register"
                className="w-full inline-flex items-center justify-center py-3.5 border-2 border-white/20 hover:border-white/50 text-foreground font-bold tracking-wider uppercase rounded-lg transition-colors duration-150 text-xs"
              >
                Start Free Trial
              </Link>
            </div>
          ...
          <div className="bg-background border-2 border-[#10b981] rounded-lg p-8 flex flex-col justify-between hover-glow relative transition-colors duration-150 transform md:-translate-y-2">
            ...
            <div className="pt-8 mt-8 border-t border-border">
              <Link
                href="/register"
                className="w-full inline-flex items-center justify-center py-4 bg-primary hover:bg-card text-foreground font-bold tracking-wider uppercase rounded-lg transition-colors duration-150 text-xs transform ]"
              >
                Get VIP Access
              </Link>
            </div>
